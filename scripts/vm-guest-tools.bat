...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://download.virtualbox.org/virtualbox/5.2.30/VBoxGuestAdditions_5.2.30.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
